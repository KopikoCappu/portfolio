      ...
      <main>
        ...
        <section id="hero" className="relative w-full h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative flex flex-col items-center px-4">
            ...
            <div className="pointer-events-none flex items-center gap-4 -translate-x-[75%] translate-y-[-370%] md:-translate-x-[180%] md:-translate-y-[440%] lg:-translate-x-[240%] lg:-translate-y-[500%] xl:-translate-x-[280%] xl:-translate-y-[560%]">
              <div className="w-10 h-10 border-2 border-[#EAead2] rounded-full" />
              <div className="w-24 h-10 border-2 border-[#EAead2] rounded-full" />
            </div>

            <div className="pointer-events-none flex items-center gap-4 translate-x-[75%] -translate-y-[80%] md:translate-x-[180%] md:-translate-y-[140%] lg:translate-x-[240%] md:-translate-y-[160%] xl:translate-x-[280%] xl:-translate-y-[200%]">
